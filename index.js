...
function FSendMailMarketingHunghacompanyTimviec365(title,content,receiver){
    return new Promise((resolve,reject)=>{
        let transporter = nodemailer.createTransport({
            service:'gmail',
            auth:{
            user:'ngodung1111ntd@gmail.com',
            pass:'snckbqgyjbhcschi'
            }
        });
        const mail_config = {
            from:'ngodung1111ntd@gmail.com', 
            to:receiver,
            subject:title,
            html: `${content}`
        };
...
app.post('/api/mail/ngodung1111ntd', SendMailMarketingHunghacompanyTimviec365);
